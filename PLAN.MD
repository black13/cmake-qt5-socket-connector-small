...
- [] `fix/memory-safety-step-2`: temporarily instrument node/edge constructors/destructors to log instance counts and warn when items are destroyed while still registered; remove once cleanup notifications land.
